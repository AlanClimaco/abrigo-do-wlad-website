...
export default function Adopt() {
    ...
    const filteredDogs = DOGS_DATA.filter(dog => {
        ...
        const matchBehavior = filterBehavior === 'all' || dog.tags.includes(filterBehavior);
